...
public class UserController
{
    ...
    {
        User foundUser = us.getUserByEmail(email.toLowerCase()); // EMAILS ARE NOT CASE SENSITIVE.
        if (null != foundUser)
        {
            return foundUser;
        }else
    ...
    public User addUser(@RequestBody Credentials creds)
    {
        ...
        try
        {
            ...
            {
            	// to lower the email... emails are not case sensitive...
            	User temp = creds.getUser();
            	temp.setEmail(temp.getEmail().toLowerCase());
